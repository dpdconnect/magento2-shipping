 ...
 */
namespace DpdConnect\Shipping\Controller\Adminhtml\Tablerate;
...
class Export extends \Magento\Config\Controller\Adminhtml\System\AbstractConfig
{
    ...
    public function execute()
    {
        ...
        /** @var $gridBlock \DpdConnect\Shipping\Block\Adminhtml\Tablerate\Grid */
        $gridBlock = $this->_view->getLayout()->createBlock(
            'DpdConnect\Shipping\Block\Adminhtml\Tablerate\Grid'
        );
