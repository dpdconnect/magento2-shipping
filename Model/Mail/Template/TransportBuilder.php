...
namespace DpdConnect\Shipping\Model\Mail\Template;
...
class TransportBuilder extends \Magento\Framework\Mail\Template\TransportBuilder
{
    ...
    protected function prepareMessage()
    {
        ...
        if (null !== $this->attachments) {
            foreach($this->attachments as $attachment) {
                $parts[] = $this->mimePartInterfaceFactory->create($attachment);
            }
        }
    ...
    public function addAttachment(
        ...
        $this->attachments[] = ['content' => $body, 'type' => $mimeType, 'disposition' => $disposition, 'encoding' => $encoding, 'filename' => $filename];
